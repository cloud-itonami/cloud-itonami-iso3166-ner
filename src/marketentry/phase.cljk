(ns marketentry.phase
  "Phase 0->3 staged rollout for the Republic of Niger (NER)
  market-entry compliance actor.
    ...
    Phase 3  supervised auto  -- governor-clean, high-confidence
                                 `:engagement/intake` (no tender/ARCOP
  ...
  real marchespublics.ne tender response / ARCOP filing package and
