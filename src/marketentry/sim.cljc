...
(defn -main [& _]
  (let [db (store/seed-db)
        actor (op/build db)]
    (println "== engagement/intake eng-1 (NER, clean) ==")
    ...
    (println "== jurisdiction/assess eng-4 (sets up redevance-sanction-range-violated) ==")
    ...
    (println "== filing/submit eng-4 (declared redevance sanction is 500,000 FCFA, below Décret 2016-642 Art.7's 1,000,000 FCFA floor -> HARD hold) ==")
    ...
    (println "== jurisdiction/assess eng-6 (sets up an IN-range redevance sanction -- clean) ==")
    ...
    (println "== filing/submit eng-6 (declared redevance sanction is 5,000,000 FCFA / 2-year exclusion, WITHIN Décret 2016-642 Art.7's bounds -- clean submit, still escalates for approval) ==")
