(ns marketentry.store
  "SSoT for the Republic of Niger (NER) market-entry compliance actor,
...
(defn demo-data
  ...
  `:prior-redevance-sanction?` / `:redevance-sanction-amount` /
  `:redevance-sanction-exclusion-years` are ground truth for the
  flagship TWO-DIMENSION STATUTORY-BOUNDS check (Décret n°2016-642/
  PRN/PM Art.7 -- does a declared prior redevance-non-payment sanction
  stay within the 1,000,000-100,000,000 FCFA amount range AND the 1-5
  year exclusion range?); `:requires-nif?` / `:nif-verified?` are
  ground truth for the conditional NIF (Numéro d'Identification
  Fiscale) check."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Niamey Négoce SARL" :procurement-channel "ARCOP (arcop.ne) / marchespublics.ne tender notice"
             ...
             :jurisdiction "NER" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :procurement-channel "ARCOP (arcop.ne) / marchespublics.ne tender notice"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :prior-redevance-sanction? false
             :requires-nif? true :nif-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Zinder Commerce SA" :procurement-channel "ARCOP (arcop.ne) / marchespublics.ne tender notice"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "NER" :status :intake}
    "eng-4" {:id "eng-4" :operator "Sahel Travaux Publics SARL" :procurement-channel "ARCOP (arcop.ne) / marchespublics.ne tender notice"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :prior-redevance-sanction? true :redevance-sanction-amount 500000 :redevance-sanction-exclusion-years 3
             :requires-nif? true :nif-verified? true
             :drafted? false :submitted? false
             :jurisdiction "NER" :status :intake}
    "eng-5" {:id "eng-5" :operator "Agadez Import-Export SARL" :procurement-channel "ARCOP (arcop.ne) / marchespublics.ne tender notice"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :prior-redevance-sanction? false
             ...
             :drafted? false :submitted? false
             :jurisdiction "NER" :status :intake}
    "eng-6" {:id "eng-6" :operator "Tahoua Construction et Cie" :procurement-channel "ARCOP (arcop.ne) / marchespublics.ne tender notice"
             :base-fee 400000 :monthly-rate 25000 :monitoring-months 6
             :claimed-fee 550000.0
             :prior-redevance-sanction? true :redevance-sanction-amount 5000000 :redevance-sanction-exclusion-years 2
             :requires-nif? true :nif-verified? true
             :drafted? false :submitted? false
             :jurisdiction "NER" :status :intake}}})
...
(defn- engagement->tx [{:keys [id operator procurement-channel base-fee monthly-rate monitoring-months claimed-fee
                               prior-redevance-sanction? redevance-sanction-amount redevance-sanction-exclusion-years
  ...
  (cond-> {:engagement/id id}
    ...
    (some? prior-redevance-sanction?)                 (assoc :engagement/prior-redevance-sanction? prior-redevance-sanction?)
    redevance-sanction-amount                         (assoc :engagement/redevance-sanction-amount redevance-sanction-amount)
    redevance-sanction-exclusion-years                (assoc :engagement/redevance-sanction-exclusion-years redevance-sanction-exclusion-years)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/procurement-channel :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/prior-redevance-sanction? :engagement/redevance-sanction-amount :engagement/redevance-sanction-exclusion-years
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :procurement-channel (:engagement/procurement-channel m)
     ...
     :prior-redevance-sanction? (boolean (:engagement/prior-redevance-sanction? m))
     :redevance-sanction-amount (:engagement/redevance-sanction-amount m)
     :redevance-sanction-exclusion-years (:engagement/redevance-sanction-exclusion-years m)
